@extends('layouts.admin', ['title' => 'Data Agregat'])
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-3 items-end">
                ...
                <form method="GET" class="lg:col-span-9">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 items-end">
                        ...
                        <div class="sm:col-span-1 md:col-span-1 lg:col-span-1">
                            <a href="{{ route('admin.data') }}" class="inline-flex items-center justify-center w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                Reset
                            </a>
                        </div>
                    </div>
            ...
            <div class="dk-tab-content mt-0" id="aggregateTabsContent">
                ...
                <div class="dk-tab-pane show active" id="tab-gender" role="tabpanel"
                    ...
                    @include('public.partials.table-heading', [
                        ...
                        'fullscreenRoute' => 'admin.data.fullscreen',
                        'downloadPdfRoute' => 'admin.data.download.pdf',
                        'downloadExcelRoute' => 'admin.data.download.excel',
                    ])
