@extends('layouts.admin', ['title' => 'Grafik Data'])
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-3 items-end">
                ...
                <form method="GET" class="lg:col-span-9">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 items-end">
                        ...
                        <div class="sm:col-span-1 md:col-span-1 lg:col-span-1">
                            <a href="{{ route('admin.charts') }}" class="inline-flex items-center justify-center w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                Reset
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 flex flex-wrap gap-3 items-start justify-between">
                        <div class="flex-1 min-w-[280px]">
                            @include('public.partials.table-heading', [
                                ...
                                'fullscreenRoute' => 'admin.charts.fullscreen',
                                'customDownloads' => view('public.partials.chart-download-button', ['category' => 'gender', 'downloadRoute' => 'admin.charts.download.pdf'])->render(),
                    ...
                    <div class="mb-4 flex flex-wrap gap-3 items-start justify-between">
                        <div class="flex-1 min-w-[280px]">
                            @include('public.partials.table-heading', [
                                ...
                                'periodLabel' => $periodLabel,
                                'fullscreenRoute' => 'admin.charts.fullscreen',
                                'customDownloads' => view('public.partials.chart-download-button', ['category' => 'age', 'downloadRoute' => 'admin.charts.download.pdf'])->render(),
                                'showDownloadButtons' => false,
                            ])
                        </div>
                    </div>
                    ...
                    <div class="mb-4 flex flex-wrap gap-3 items-start justify-between">
                        <div class="flex-1 min-w-[280px]">
                            @include('public.partials.table-heading', [
                                ...
                                'periodLabel' => $periodLabel,
                                'fullscreenRoute' => 'admin.charts.fullscreen',
                                'customDownloads' => view('public.partials.chart-download-button', ['category' => 'single-age', 'downloadRoute' => 'admin.charts.download.pdf'])->render(),
                                'showDownloadButtons' => false,
                    ...
                    <div class="mb-4 flex flex-wrap gap-3 items-start justify-between">
                        <div class="flex-1 min-w-[280px]">
                            @include('public.partials.table-heading', [
                                ...
                                'periodLabel' => $periodLabel,
                                'fullscreenRoute' => 'admin.charts.fullscreen',
                                'customDownloads' => view('public.partials.chart-download-button', ['category' => 'education', 'downloadRoute' => 'admin.charts.download.pdf'])->render(),
                                'showDownloadButtons' => false,
                    ...
                    <div class="mb-4 flex flex-wrap gap-3 items-start justify-between">
                        <div class="flex-1 min-w-[280px]">
                            @include('public.partials.table-heading', [
                                ...
                                'periodLabel' => $periodLabel,
                                'fullscreenRoute' => 'admin.charts.fullscreen',
                                'customDownloads' => view('public.partials.chart-download-button', ['category' => 'occupation', 'downloadRoute' => 'admin.charts.download.pdf'])->render(),
                                'showDownloadButtons' => false,
                    ...
                    <div class="mb-4 flex flex-wrap gap-3 items-start justify-between">
                        <div class="flex-1 min-w-[280px]">
                            @include('public.partials.table-heading', [
                                ...
                                'periodLabel' => $periodLabel,
                                'fullscreenRoute' => 'admin.charts.fullscreen',
                                'customDownloads' => view('public.partials.chart-download-button', ['category' => 'marital', 'downloadRoute' => 'admin.charts.download.pdf'])->render(),
                                'showDownloadButtons' => false,
                            ])
                        </div>
                    </div>
                    ...
                    <div class="mb-4 flex flex-wrap gap-3 items-start justify-between">
                        <div class="flex-1 min-w-[280px]">
                            @include('public.partials.table-heading', [
                                ...
                                'periodLabel' => $periodLabel,
                                'fullscreenRoute' => 'admin.charts.fullscreen',
                                'customDownloads' => view('public.partials.chart-download-button', ['category' => 'household', 'downloadRoute' => 'admin.charts.download.pdf'])->render(),
                                'showDownloadButtons' => false,
                            ])
                        </div>
                    </div>
                    ...
                    <div class="mb-4 flex flex-wrap gap-3 items-start justify-between">
                        <div class="flex-1 min-w-[280px]">
                            @include('public.partials.table-heading', [
                                ...
                                'periodLabel' => $periodLabel,
                                'fullscreenRoute' => 'admin.charts.fullscreen',
                                'customDownloads' => view('public.partials.chart-download-button', ['category' => 'religion', 'downloadRoute' => 'admin.charts.download.pdf'])->render(),
                                'showDownloadButtons' => false,
                            ])
                        </div>
                    </div>
                    ...
                    <div class="mb-4 flex flex-wrap gap-3 items-start justify-between">
                        <div class="flex-1 min-w-[280px]">
                            @include('public.partials.table-heading', [
                                ...
                                'periodLabel' => $periodLabel,
                                'fullscreenRoute' => 'admin.charts.fullscreen',
                                'customDownloads' => view('public.partials.chart-download-button', ['category' => 'wajib-ktp', 'downloadRoute' => 'admin.charts.download.pdf'])->render(),
                                'showDownloadButtons' => false,
                            ])
                        </div>
                    </div>
